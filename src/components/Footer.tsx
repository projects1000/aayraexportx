                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            <div className="relative w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gray-800 flex items-center justify-center overflow-hidden">
                                <Image
                                    src="/logo.png"
                                    alt="AAYRAEXPORTX Logo"
                                    width={24}
                                    height={24}
                                    className="object-cover sm:w-7 sm:h-7"
                                />
                            </div>
                            <span className="text-xl sm:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-600">
                                AayraExportX
                            </span>
                        </Link>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="text-gray-400 hover:text-green-500 hover:-translate-y-1 transition-all duration-300 p-2" aria-label="Facebook">
                                <Facebook size={20} />
                            </a>
                            <a href="#" className="text-gray-400 hover:text-green-500 hover:-translate-y-1 transition-all duration-300 p-2" aria-label="Twitter">
                                <Twitter size={20} />
                            </a>
                            <a href="#" className="text-gray-400 hover:text-green-500 hover:-translate-y-1 transition-all duration-300 p-2" aria-label="LinkedIn">
                                <Linkedin size={20} />
                            </a>
                            <a href="#" className="text-gray-400 hover:text-green-500 hover:-translate-y-1 transition-all duration-300 p-2" aria-label="Instagram">
                                <Instagram size={20} />
                            </a>
                        </div>
                        <div className="mt-6">
                            <a href="https://wa.me/919702160068?text=Hello!%20I%20am%20interested%20in%20bulk%20eucalyptus%20wood%20poles." target="_blank" rel="noopener noreferrer">
                                <button className="px-6 py-3 rounded-full bg-gradient-to-r from-green-600 to-green-700 text-white font-bold text-sm shadow-lg hover:shadow-[0_0_20px_rgba(34,197,94,0.5)] hover:scale-105 transition-all duration-300">
                                    Get Bulk Quote
                                </button>
                            </a>
                        </div>
